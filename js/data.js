...
const CHAYKHUN_DISTRICT_NAME = "Раёни Чайхун";
const TAJIKISTAN_LOCATION_TREE = {
  name: "Таджикистан",
  sections: [
    { label: "КРУПНЫЕ ГОРОДА", locations: TJK_MAJOR_CITIES },
    {
      label: "РАЙОНИ ДЖАЙХУН",
      locations: [{ name: CHAYKHUN_DISTRICT_NAME, children: CHAYKHUN_VILLAGES }],
    },
  ],
};
const LOCATION_COUNTRY_TREE = [
  { id: "ru", name: "Россия", flag: "\ud83c\uddf7\ud83c\uddfa", locations: FOREIGN_CITIES },
  { id: "tj", name: "Таджикистан", flag: "\ud83c\uddf9\ud83c\uddef", sections: TAJIKISTAN_LOCATION_TREE.sections },
];
const CITIES = TJK_MAJOR_CITIES.slice();
const CITY_ALIASES = {
  ...
  "Райони Чайхун": CHAYKHUN_DISTRICT_NAME,
  "Раёни Чайхун": CHAYKHUN_DISTRICT_NAME,
  "Район Чайхун": CHAYKHUN_DISTRICT_NAME,
  "Дехаи Геран": "Дехаи Геран",
  "Дехаи Якум": "Дехаи Якум",
  "Дехаи Дуввум": "Дехаи Дуввум",
  "Дехаи Севвум": "Дехаи Севвум",
  "Дехаи Чахорум": "Дехаи Чахорум",
  "Дехаи Панчум": "Дехаи Панчум",
  "Дехаи Шашум": "Дехаи Шашум",
  "Дехаи Хафтум": "Дехаи Хафтум",
  "Дехаи Хаштум": "Дехаи Хаштум",
  "Дехаи Нухум": "Дехаи Нухум",
  "Дехаи Дахум": "Дехаи Дахум",
  "Бозор": "Бозор",
  "Аэрапорт": "Аэрапорт",
